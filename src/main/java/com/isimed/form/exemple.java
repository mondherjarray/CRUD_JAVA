...
public class exemple extends javax.swing.JFrame {
    ...
    public void loadData() {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new String[] { "ID", "First Name", "Last Name", "email" },
                    0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(exemple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
